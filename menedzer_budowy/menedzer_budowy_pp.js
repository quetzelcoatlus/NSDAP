...
for (const e of queue.split(' ')) {
    console.log(e)
    while(document.querySelector("#main_buildrow_" + e.split('_')[0] + " > td.build_options > div") &&
          !document.querySelector("#main_buildrow_" + e.split('_')[0] + " > td.build_options > div").innerHTML.match(/0:00:0[0-9]/g) && 
          !document.querySelector("#main_buildrow_" + e.split('_')[0] + " > td.build_options > div").innerHTML == '' ||
